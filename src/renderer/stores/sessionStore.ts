...
export type BuiltinElementType = 'terminal' | 'file' | 'note' | 'webview' | 'image' | 'snippet'
export type PluginElementType = `plugin:${string}`
export type ElementType = BuiltinElementType | PluginElementType
